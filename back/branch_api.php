...
if ($input)
{
	...
	if (isset($input["video_sort"]) && $input["video_sort"]!="") {


		$sql_q = "UPDATE ".trim($input["type"])." SET _sort='".trim($input["video_sort"])."' WHERE id=".trim($input["video_id"]);
	...
	if (isset($input["video_titl"]) && $input["video_titl"]!="") {


		$sql_q = "UPDATE ".trim($input["type"])." SET _text='".trim($input["video_titl"])."' WHERE id=".trim($input["video_id"]);
