...
class DataBase
{
    private $dbname = "flowerwall_2023";
    private $login = "flowerwall_mysql";
    private $password = "e9givG+k";
    public $db;
    public static $host = 'https://flowervalley.ru/';
    public static $baseUrl = 'https://flowervalley.ru/back';
    public function __construct()
    {
        $this->db = new PDO("mysql:host=localhost;dbname=" . $this->dbname . ";charset=UTF8", $this->login, $this->password, array(PDO::MYSQL_ATTR_INIT_COMMAND => "SET NAMES utf8"));
